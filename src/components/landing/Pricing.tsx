...
export function Pricing() {
  return (
    <section id="planes" className="border-t border-line">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {plans.map((plan) => (
            ...
            >
              ...
              <a
                href="#"
                className={`mt-8 rounded-full px-6 py-3 text-center text-sm font-bold tracking-wide transition-transform hover:scale-[1.02] ${
                  plan.highlighted
                    ? 'bg-ember text-bg'
